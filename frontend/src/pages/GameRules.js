...
function GameRules() {
        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    <h3 className="text-lg font-semibold mb-2" style={{ color: headingColor }}>Scoring (Out of 500)</h3>
                    <ul className="list-disc pl-6 mb-4" style={{ color: textColor }}>
                        <li>Humor: 20%</li>
                        <li>Chemistry: 20%</li>
                        <li>Creativity: 20%</li>
    ...
    return (
        <div className="rules-page flex flex-col items-center" style={{ color: textColor }}>
            <div className="page-header w-full max-w-4xl" style={{ borderBottom: `3px solid ${themes[currentTheme].primary}`, paddingBottom: '1rem' }}>
            ...
            <div className="grid gap-4 mt-0 w-full max-w-4xl" style={{ minWidth: '80vw' }}>
                {sections.map((section, idx) => (
                    <Card key={section.title} className="overflow-hidden">
                        <button
                            className="w-full flex justify-between items-center text-left select-none m-0"
                            style={{ background: 'none', border: 'none', color: themes[currentTheme].primary, fontWeight: 600, fontSize: '1.25rem', cursor: 'pointer', outline: 'none', boxShadow: 'none', padding: 0 }}
                        ...
                        <div
                            ...
                            style={{ maxHeight: openIndex === idx ? 2000 : 0, overflow: 'hidden', transition: 'max-height 0.3s cubic-bezier(0.4,0,0.2,1)', padding: 0 }}
                            aria-hidden={openIndex !== idx}
                        >
                            <div className="pt-2" style={{ paddingLeft: 0, paddingRight: 0, paddingBottom: 0 }}>{openIndex === idx && section.content}</div>
                        </div>
                    </Card>
                ))}
            </div>
